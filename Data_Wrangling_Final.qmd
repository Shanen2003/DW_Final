...
For A5, while all other variables are held constant, for every time A5 goes up, the log odds chance of being accepted also increases by .1827, or 20%

For A8, while all other variables are held constant, when A8 is 1, the log odds chance of being accepted also increases by 3.4719, or 3119%.

For A9, while all other variables are held constant, when A9 is 1, the log odds chance of being accepted also increases by 1.2275, or 241%.
